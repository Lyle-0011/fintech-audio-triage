...
> Design notes for **fintech-audio-triage** — a runnable typescript example that Transcribe fintech recordings and emit a constrained operator action from a TypeScript CLI.
...
- **Feature code** — the actual task: fintech-audio-triage.
